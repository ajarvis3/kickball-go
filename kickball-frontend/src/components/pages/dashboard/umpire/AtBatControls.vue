...
const model = defineModel({ type: Object as PropType<{ playerId: string; rbi: number; selectedOutcome: string }>, default: () => ({ playerId: '', rbi: 0, selectedOutcome: '' }) });
  ...
  <section class="atbat-controls">
    ...
    <div>
      <q-btn
        ...
        :disable="props.posting || !model.selectedOutcome || !model.playerId || !props.currentTeamId"
      >Post Outcome</q-btn>
    </div>
    ...
    <q-dialog v-model="showConfirmDialog">
      <q-card style="min-width: 320px">
        ...
        <q-card-actions align="right">
          ...
          <q-btn flat label="Confirm" color="primary" @click="onConfirm" :loading="props.posting" />
        </q-card-actions>
      </q-card>
    </q-dialog>
  </section>
...
<style scoped>
.atbat-controls > div { margin-bottom: 0.5rem; }
</style>
